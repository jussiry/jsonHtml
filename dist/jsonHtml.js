...
(function() {
  var allActionsMap, bindEvent, createElementAndIterateChildren, create_html_node, dasherize, eventAttrsMap, eventName, globalRef, i, j, jsonHtml, len, len1, merge, ref, ref1, setAttribute, stackDepth, tagName, tagsMap, transpile,
    slice = [].slice;
  ...
  jsonHtml.createNode = function(tmplObj, rootNode) {
    if (rootNode == null) {
      rootNode = document.createDocumentFragment();
    }
    return transpile(rootNode, tmplObj);
  };
